...
public class Scene1Controller {
    ...
    Image lou = new Image(getClass().getResourceAsStream("images/lou.jpeg"));
    Image kiether = new Image(getClass().getResourceAsStream("images/kiether.png"));
    Image[] imageArray = { lark, arjay, kaide, lhara, jherick, lou, kiether };
    ...
    public void interested(ActionEvent event) throws IOException {
        ...
        if (counter == 6) {
            ...
            scene2Controller.selectImage(scene2Controller.lou);
        } else if (counter == 4) {
