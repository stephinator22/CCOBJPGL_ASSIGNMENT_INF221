...
public class CheckoutController implements Initializable {
    ...
    public void computeTotal(ActionEvent event) {
        ...
        if (HomeController.blamp.getProductStatus()) {
            ...
            HomeController.blamp.setProductQuantity(qty1);
            item1Amount = HomeController.blamp.getProductPrice()*qty1;
            price1.setText(Double.toString(item1Amount));
        ...
        if (HomeController.clamp.getProductStatus()) {
            ...
            HomeController.clamp.setProductQuantity(qty2);
            item2Amount = HomeController.clamp.getProductPrice()*qty2;
            price2.setText(Double.toString(item2Amount));
        ...
        if (HomeController.wlamp.getProductStatus()) {
            ...
            HomeController.wlamp.setProductQuantity(qty3);
            item3Amount = HomeController.wlamp.getProductPrice()*qty3;
            price3.setText(Double.toString(item3Amount));
